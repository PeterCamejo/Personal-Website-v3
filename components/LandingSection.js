import {Box, Text, Center, Heading, Container, useColorModeValue} from "@chakra-ui/react"
import { motion } from "framer-motion"

const LandingSection = () =>{

    return(
    <Box id="landingSection"  display="flex" p="60px" backgroundColor={useColorModeValue('#f58c00', '#03002e' )}  h='100vh' w='100%' justifyContent="start" alignItems="center" >
